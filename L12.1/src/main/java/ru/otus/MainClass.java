...
/*
        ...
        try (DBService dbService = new DBServiceMyOrmImpl("ru/otus",
                UserDataSet.class,
...
*/
    ...
    private static void prepareDB(DBService dbService) throws MyOrmException {
